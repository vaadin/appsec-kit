...
public class AppSecConfigurationTest {
    ...
    public void dataPathNotSet_systemPropertyNotSet_defaultIsUsed() {
        ...
        assertEquals(Paths.get(AppSecConfiguration.DEFAULT_DATA_FILE_PATH,
                AppSecConfiguration.DEFAULT_DATA_FILE_NAME), dataFilePath);
    }
    ...
    public void dataPathNotSet_systemPropertySet_systemPropertyIsUsed() {
        ...
        assertEquals(Paths.get("custom-path", AppSecConfiguration.DEFAULT_DATA_FILE_NAME),
                dataFilePath);
    }
